        ...
        <Container>
          <div className="flex gap-5 items-center">
            <div className="w-5/12">
              <div>
                <h1
                  className="font-mono text-5xl font-medium text-[#101C45] mb-4"
                  data-aos="fade-down"
                >
                  Get the healthcare you need, when you need it.
                </h1>
                <p
                  className="font-mono text-lg font-normal text-[#101C45] mb-10"
                  data-aos="fade-right"
                >
                ...
                <button
                  className=" bg-[#203271] text-white font-normal px-[35px] py-[15px] text-lg mb-32"
                  data-aos="zoom-in"
                >
                  Book an Appointment
                </button>
            ...
            <div className="w-7/12 justify-end flex relative">
              <div
                className="p-5 bg-white shadow-quotes rounded-lg max-w-[292px] absolute left-0 top-24"
                data-aos="flip-left"
              >
                {/* PROFIL */}
